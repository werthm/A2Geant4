...
{ 
  ...
  fUseTAPSCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fUseCBCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fUsePIDCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fUseMWPCCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fUseTargetCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTargetMatCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTargetLengthCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTargetMagneticCoilsCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTargetMagneticFieldCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fHemiGapCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTAPSFileCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTAPSZCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTAPSNCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTAPSPbCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fPIDZCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fUseTOFCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fTOFFileCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fUseCherenkovCmd->AvailableForStates(G4State_Init,G4State_Idle);
  ...
  fPizzaZCmd->AvailableForStates(G4State_Init,G4State_Idle);
}
